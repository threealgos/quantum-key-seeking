...
# =============================================================================
# Final Best Version with all corrections and features
...
# ✅ Full error mitigation (Pauli Twirling, manual ZNE, XY8 DD)
# ✅ Toggleable TKET integration
# ✅ Helios hardware support (H1-1E/H2-1 via Q-Nexus)
# ✅ Selene simulator support (PyPI or GitHub)
# ✅ Automatic authentication (qnx.login())
...
# ✅ Compatible with Q-Nexus documentation (submit, results, limits)
# =============================================================================
import os
import sys
import subprocess
...
# TKET imports (optional, toggleable)
...
# Q-Nexus imports (for Helios hardware)
...
def initialize_system():
    ...
    print("\n" + "="*80)
    print("🐉 DRAGON_CODE Guppy Q-Nexus — Backends Selection..")
    print("="*80)
...
# ===== TKET TOGGLE =====
USE_TKET = TKET_AVAILABLE and (input("Enable TKET optimization? [y/n] → ").lower() == 'y')
